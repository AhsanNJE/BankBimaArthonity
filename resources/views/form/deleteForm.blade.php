<div id="deleteFormModal" class="modal-container">
    <div class="modal-subject" style="width: 40%; margin:10% auto;">
        <div class="modal-heading">
            ...
            <span class="close-modal" data-modal-id="deleteFormModal" style="top: 10px;">&times;</span>
        </div>
        <p class="center">Are you sure you want to delete this Form?</p>
