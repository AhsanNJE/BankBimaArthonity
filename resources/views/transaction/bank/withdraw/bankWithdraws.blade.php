...
@section('admin')
    <div class="add-search">
        <div class="row">
            <div class="col-md-3">
                <button class="open-modal add" data-modal-id="addBankWithdraw">Add Bank Withdraw</button>
            </div>
            <div class="col-md-2">
    ...
    <!-- table show -->
    <div class="withdraw" style="overflow-x:auto;">
        @include('transaction.bank.bankTransactionPagination')
    </div>


    @include('transaction.bank.withdraw.addBankWithdraw')
...
@section('ajax')
    <script src="{{ asset('js/ajax/transaction/bank_withdraw.js') }}"></script>
