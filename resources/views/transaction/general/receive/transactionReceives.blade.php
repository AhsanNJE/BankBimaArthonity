...
@section('admin')
    <div class="add-search">
        <div class="row">
            <div class="col-md-3">
                <button class="open-modal add" data-modal-id="addTransactionReceive">Add Transaction Receive</button>
            </div>
            <div class="col-md-2">
    ...
    <!-- table show -->
    <div class="transaction-receive" style="overflow-x:auto;">
        @include('transaction.general.transactionPagination')
    </div>


    @include('transaction.general.receive.addTransactionReceive')
...
@section('ajax')
    <script src="{{ asset('js/ajax/transaction/general/transaction_receive.js') }}"></script>
