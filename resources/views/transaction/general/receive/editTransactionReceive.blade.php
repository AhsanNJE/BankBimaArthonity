    ...
    <div class="modal-subject">
        <div class="center">
            <div class="card card-primary col-md-12">
                ...
                <!-- form start -->
                <form id="EditTransactionReceiveForm" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="center">
                                    <button type="submit" id="UpdateTransactionReceive" class="btn btn-success">Add</button>
                                </div>
                            </div>
                        </div>
