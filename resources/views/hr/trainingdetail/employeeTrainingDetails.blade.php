...
@section('admin')
    <div class="add-search">
        <div class="row">
            <div class="col-md-3">
                <button class="open-modal add" data-modal-id="EmployeeTraining">Add Training Detail</button>
            </div>
    ...
    <div class="employee" style="overflow-x:auto;">
        @include('hr.trainingdetail.employeeTrainingDetailPage')
    </div>
...
@section('ajax')
    <script src="{{ asset('js/ajax/hr/employeeTraining.js') }}"></script>
