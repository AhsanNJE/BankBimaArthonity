...
@section('admin')
    ...
    <!-- table show -->
    <div class="details-balance" style="overflow-x:auto;">
        @include('reports.balance_sheet.details.detailsBalanceSheetPagination')
    </div>
...
@section('ajax')
    <script src="{{ asset('js/ajax/report/details_balance_sheet.js') }}"></script>
@endsection
