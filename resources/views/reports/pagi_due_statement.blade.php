<table id="basic-datatable" class="table dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <span class="btn btn-success btn-sm waves-effect waves-light"> {{ round($item->net_amount) }}</span> </td>
                        ...
                        <tfoot>
                            ...
                            @endphp
                            <tr>
                                <th colspan="5"><h4 class="text-right text-bold">Total : </h4></th>
                                <th><h4 class="text-left text-bold">{{ $total_amount }}</h4></th>
                                <th><h4 class="text-left text-bold">{{ $total_receive }}</h4></th>
                                <th><h4 class="text-left text-bold">{{ $total_payment }}</h4></th>
                                <th><h4 class="text-left text-bold">{{ $total_due }}</h4></th>
                                <th></th>
                            </tr>
                        </tfoot>
                    </table>
