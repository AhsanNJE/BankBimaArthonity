<table class="show-table">
    <thead>
        <caption class="caption">Supplier Return Details</caption>
        <tr>
            <th>SL:</th>
            <th>Id</th>
            <th>User</th>
    ...
    <tbody>
        @foreach ($supplierreturn as $key => $item)
            <tr>
                <td>{{ $supplierreturn->firstItem() + $key }}</td>
                <td>{{ $item->tran_id }}</td>
                ...
                <td>
                    <div style="display: flex;gap:5px;">
                        ...
                        <button class="open-modal editSupplierReturn" data-modal-id="editSupplierReturn" id="edit"
