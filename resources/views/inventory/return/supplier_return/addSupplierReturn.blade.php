...
<div id="addSupplierReturn" class="modal-container">
    <div class="modal-subject">
        <div class="center">
            <div class="card card-primary col-md-12">
                <div class="card-header">
                    <div class="center">
                        <h3 class="card-title">Add Supplier Return</h3>
                        <span class="close-modal" data-modal-id="addSupplierReturn">&times;</span>
                    </div>
                </div>
                
                <!-- form start -->
                <form id="AddSupplierReturnForm" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="batchId" class="form-control" id="batchId">
                                        <span class="text-danger error" id="batchId_error"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cp" class="form-control" id="cp" readonly>
                                ...
                                <div class="center">
                                    <button type="submit" id="InsertSupplierReturn" class="btn btn-success">Add</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
