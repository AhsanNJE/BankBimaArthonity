<div id="editInventoryReturn" class="modal-container">
    <div class="modal-subject">
        <div class="center">
            <div class="card card-primary col-md-12">
                <div class="card-header">
                    <div class="center">
                        <h3 class="card-title">Edit Inventory Return</h3>
                        <span class="close-modal" data-modal-id="editInventoryReturn">&times;</span>
                    </div>
                </div>
