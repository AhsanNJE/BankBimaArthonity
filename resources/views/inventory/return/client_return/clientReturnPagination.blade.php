<table class="show-table">
    <thead>
        <caption class="caption">Client Return Details</caption>
        <tr>
            <th>SL:</th>
            <th>Id</th>
            <th>User</th>
    ...
    <tbody>
        @foreach ($clientreturn as $key => $item)
            <tr>
                <td>{{ $clientreturn->firstItem() + $key }}</td>
                <td>{{ $item->tran_id }}</td>
                ...
                <td>
                    <div style="display: flex;gap:5px;">
                        ...
                        <button class="open-modal editClientReturn" data-modal-id="editClientReturn" id="edit"
