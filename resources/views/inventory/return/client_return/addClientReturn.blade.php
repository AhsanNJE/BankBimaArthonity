...
<div id="addClientReturn" class="modal-container">
    <div class="modal-subject">
        <div class="center">
            <div class="card card-primary col-md-12">
                <div class="card-header">
                    <div class="center">
                        <h3 class="card-title">Add Client Return</h3>
                        <span class="close-modal" data-modal-id="addClientReturn">&times;</span>
                    </div>
                </div>
                
                <!-- form start -->
                <form id="AddClientReturnForm" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="center">
                                    <button type="submit" id="InsertClientReturn" class="btn btn-success">Add</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
