...
<div id="addPositiveAdjustment" class="modal-container">
    <div class="modal-subject">
        <div class="center">
            <div class="card card-primary col-md-12">
                <div class="card-header">
                    <div class="center">
                        <h3 class="card-title">Add Positive Adjustment</h3>
                        <span class="close-modal" data-modal-id="addPositiveAdjustment">&times;</span>
                    </div>
                </div>

                <!-- form start -->
                <form id="AddPositiveAdjustmentForm" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
