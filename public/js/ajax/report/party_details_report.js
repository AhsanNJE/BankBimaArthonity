$(document).ready(function () {
    ...
    $(document).on('keyup', '#search', function (e) {
        ...
        let type = $('#typeOption').val();
        let search = $(this).val();
        searchTransaction(`/party/details/report/search`, {startDate:startDate, endDate:endDate, type:type, search:search})
    });
    ...
    $(document).on('click', '.search-paginate a', function (e) {
        ...
        let search = $(this).val();
        let page = $(this).attr('href').split('page=')[1];
        searchTransaction(`/party/details/report/search/pagination?page=${page}`, {startDate:startDate, endDate:endDate, type:type, search:search})
    });
